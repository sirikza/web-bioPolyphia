    ...
    <div class="container">
        ...
        <div class="container px-4">
            <form class="row g-1" id="sample_form">
                <h1 class="text-danger text-center mt-5">LOGIN</h1>
                <div class="col-md-12">
                ...
                <div class="col-12">
                    <button type="submit" class="btn btn-primary" id="action_button">Masuk</button>
                </div>
            </form>
        </div>
    </div>
    <script>
        $(document).ready(function() {
            ...
            $('#sample_form').on('submit', function(event) {
                ...
                $.ajax({
                    url: "http://localhost/web_bio_rikza/si-admin/api/auth/login.php",
                    method: "POST",
